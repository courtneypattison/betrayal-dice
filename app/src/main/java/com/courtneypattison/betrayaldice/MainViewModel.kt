...
class MainViewModel : ViewModel() {
    ...
    val outcomeProbabilities = arrayOf(
        ...
        intArrayOf(11, 22, 33, 22),
        intArrayOf(4, 11, 22, 26, 22, 11, 4),
        intArrayOf(1, 5, 12, 20, 23, 20, 12, 5, 1),
        intArrayOf(0, 2, 6, 12, 19, 21, 19, 12, 6, 2),
        intArrayOf(0, 1, 3, 7, 12, 17, 19, 17, 12, 7, 3, 1),
        intArrayOf(0, 0, 1, 4, 7, 12, 16, 18, 16, 12, 7, 4, 1),
        intArrayOf(0, 0, 1, 2, 4, 8, 12, 15, 17, 15, 12, 8, 4, 2, 1)
    )
